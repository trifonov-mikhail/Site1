...
<div style="padding-left: 30px;">
	...
	<div>
		...
		<ol>
		    <li> Серийный номер представляет собой одиннадцати- или двенадцатизначный буквенно-цифровой код, уникальный для каждого продукта. 
			     При проверке серийного номера первую букву S вводить не следует (это кодировка словосочетания «Serial No»). 
				 Все буквенные символы должны быть введены с использованием только латиницы.
			</li>
		...
		<ol>
			<li>Код региона:</li>
			<ul>
				<li><img src="/images/bullet.gif" alt="">Для Мас – UA/A, RS/A (очень редко ZH/A)</li>
				<li><img src="/images/bullet.gif" alt="">Для всех iPod, кроме iPod touch, - QB/A</li>
				<li><img src="/images/bullet.gif" alt="">Кроме iPod touch – RP/A</li>
			</ul>
		</ol>
		<br />
		<p>
			<u>Комментарий</u>: 
			Если код региона отличается от вышеуказанных вариантов, то это означает, что поставки данного товара не 
			были авторизованы компанией Apple на территорию Украины. 
			Компания Apple официально поставляет в Украину продукты только с локализацией UA/A (украинская) и RS/A (русская).*
          	<br />
			*<u>Исключение</u>: 
			Если продукт приобретен за пределами Украины, то для получения сервисного обслуживания следует предоставить оригиналы 
			документов, подтверждающих покупку.		
		</p>
		<p>
			&nbsp;</p>
		<p>
			<strong>ПРИМЕРЫ идентификаторов</strong></p>
			
		<!-- пример1 -->	
			
				<p>
			
			<strong>Ноутбук Apple MacBook Pro 15W" с дисплеем Retina в алюминиевом корпусе</strong>
			<br />
			<strong> MB Pro 15.4/Intel Core i7 2.3GHz/8GB/256GB  </strong><br />
			<strong>flash/HD Graphics 4000/GeForce GT6T </strong>
			...
			<tr>
				<td valign="top">
					<ul>
						...
						<li>2. Серийный номер (двенадцатизначный буквенно-цифровой код) </li>
						<li>3. Модель</li>
					</ul>
				</td>
				<td style="padding-left: 20px;">
					<img src="../images/shtrih-pro15.jpg" alt="" width="343" height="268" />
				</td>
			</tr>
		</table>
		<p>
		...
		<p>
			...
			<br />
			<strong>MB 13.3/</strong><strong>2.0GHz/2x</strong><strong>1GB</strong><strong>/160G</strong>
			<strong>B</strong><strong>/SD</strong>
