...
{
    public partial class ServiceCenters : UserControlBase
    {
        ...
        {
            //ddlRegions.Attributes["onfocus"] = "expandSELECT(this);";
			//ddlRegions.Attributes["onblur"] = "contractSELECT(this);";
            map1.DdlRegionsID = ddlRegions.ClientID;
            map1.BtnShowID = btnShow.ClientID;
        }
        ...
        protected void rItems_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            //{
            //    Service s = (Service)e.Item.DataItem;
            //    Label spec = (Label)e.Item.FindControl("lblSpecialization");

            //    List<string> all = (new ServiceSpecializations()).GetListSpecializationByService(s);
