<%@ Control Language="C#" AutoEventWireup="true" Codebehind="MainOneNews.ascx.cs"
    Inherits="Apple.Web.Controls.MainOneNews" %>
<asp:FormView ID="fvItem" runat="server" DataSourceID="odsItem" OnDataBound="fvItem_DataBound">
    <ItemTemplate>
...
<asp:ObjectDataSource ID="odsItem" runat="server" OldValuesParameterFormatString="original_{0}"
    OnSelecting="odsItem_Selecting" SelectMethod="GetMainByLang" TypeName="Erc.Apple.Data.News">
    <SelectParameters>
