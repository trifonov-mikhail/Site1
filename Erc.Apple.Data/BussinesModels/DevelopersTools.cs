...
namespace Erc.Apple.Data
{
	...
	public class DevelopersTools
    {
        public static int SequenceID = 14;
        ...
        public virtual List<DevelopersTool> GetAll(string langCode)
        {
            List<DevelopersTool> all = new List<DevelopersTool>();
            using (StoredProcedure sp = new StoredProcedure("DevelopersTools_GetAll"))
            {
                ...
                using (SqlDataReader r = (SqlDataReader)sp.ExecuteReader())
                {
                    if (r != null)
                    {
                        while (r.Read())
                        {
                            DevelopersTool item = new DevelopersTool();
        ...
        public virtual DevelopersTool GetByID(int id)
        {
            DevelopersTool item = null;
            using (StoredProcedure sp = new StoredProcedure("DevelopersTools_GetByID"))
            {
        ...
        {
            byte[] item = null;
            using (StoredProcedure sp = new StoredProcedure("DevelopersTools_GetImage"))
            {
        ...
        public virtual DevelopersTool GetByLangGroup(string language, int groupId)
        {
            DevelopersTool item = null;
            using (StoredProcedure sp = new StoredProcedure("DevelopersTools_GetByLangGroup"))
            {
                sp.Params.Add("@GroupID", System.Data.SqlDbType.Int).Value = groupId;
        ...
        public virtual int Add(DevelopersTool item)
        {
            int newID = 0;
            using (StoredProcedure sp = new StoredProcedure("DevelopersTools_AddItem"))
            {
        ...
        public virtual bool Update(DevelopersTool item)
        {
            bool result = false;
            using (StoredProcedure sp = new StoredProcedure("DevelopersTools_UpdateItem"))
            {
                sp.Params.Add("@GroupID", System.Data.SqlDbType.Int).Value = item.GroupID;
                sp.Params.Add("@LangCode", System.Data.SqlDbType.NChar).Value = item.LangCode;
                sp.Params.Add("@Title", System.Data.SqlDbType.NVarChar, 255).Value = item.Title;
        ...
        {
            bool result = false;
            using (StoredProcedure sp = new StoredProcedure("DevelopersTools_UpdateImage"))
            {
                sp.Params.Add("@GroupID", System.Data.SqlDbType.Int).Value = groupID;
        ...
        {
            bool result = false;
            using (StoredProcedure sp = new StoredProcedure("DevelopersTools_DeleteImage"))
            {
                sp.Params.Add("@GroupID", System.Data.SqlDbType.Int).Value = groupID;
        ...
        public bool DeleteGroup(DevelopersTool item)
        {
            bool result = false;
            using (StoredProcedure sp = new StoredProcedure("DevelopersTools_DeleteGroup"))
            {
                sp.Params.Add("@GroupID", System.Data.SqlDbType.Int).Value = item.GroupID;
