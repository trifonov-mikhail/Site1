<%@ Control Language="C#" AutoEventWireup="true" Codebehind="StoriesEditor.ascx.cs"
    Inherits="Apple.Web.Admin.Controls.Editors.StoriesEditor" %>
<%@ Register TagPrefix="uc" TagName="DatePicker" Src="~/Controls/DatePicker.ascx" %>
<%@ Register TagPrefix="uc" TagName="editor" Src="~/Controls/Editors/StoryEditor.ascx" %>
...
<asp:MultiView ID="MvEditor" runat="server" ActiveViewIndex="0">
    <asp:View ID="ViewList" runat="server">
        ...
        <asp:ObjectDataSource ID="ObjectDataSourceItemsList" runat="server" SelectMethod="GetAll"
            TypeName="Erc.Apple.Data.Stories" DataObjectTypeName="Erc.Apple.Data.Story" DeleteMethod="DeleteGroup">
            <SelectParameters>
                ...
                <%--<tr style="background-color: rgb(239, 243, 251);">
                    ...
                    <td rowspan="2">
                        <table border="0" cellspacing="0">
                            <tr>
                                <td>
                                    <img height="55" alt='Image' src='<%=this.ResolveUrl("~/GetImage.ashx?type=4&id="+this.GroupID) %>' /></td>
                                <td>
