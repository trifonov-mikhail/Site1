...
{
    public partial class StoriesEditor : UserControlBase, Apple.Web.Admin.Interfaces.IAddControl
    {
        ...
        {
            StoryEditor editor = (StoryEditor)sender;
        ...
        private void Save()
        {
            foreach (RepeaterItem item in RepeaterLang.Items)
            {
                ...
                {
                    StoryEditor editor = (StoryEditor)item.FindControl("editor");
