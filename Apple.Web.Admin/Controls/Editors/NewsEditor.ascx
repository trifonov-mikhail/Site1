<%@ Control Language="C#" AutoEventWireup="true" Codebehind="NewsEditor.ascx.cs"
    Inherits="Apple.Web.Admin.Controls.Editors.NewsEditor" %>
<%@ Register TagPrefix="uc" TagName="DatePicker" Src="~/Controls/DatePicker.ascx" %>
<%@ Register TagPrefix="uc" TagName="editor" Src="~/Controls/Editors/NewsItemEditor.ascx" %>
    ...
    <asp:View ID="ViewList" runat="server">
        <asp:GridView ID="GridViewItemsList" runat="server" Width="100%" AutoGenerateColumns="False"
            ...
            <Columns>
                ...
                <asp:CheckBoxField DataField="IsMain" HeaderText="Главная">
        ...
        <asp:ObjectDataSource ID="ObjectDataSourceItemsList" runat="server" SelectMethod="GetAll"
            TypeName="Erc.Apple.Data.News" DataObjectTypeName="Erc.Apple.Data.NewsItem" DeleteMethod="DeleteGroup">
            <SelectParameters>
        ...
        <div style="width: 100%; text-align: left;">
            <table width="550" border="0" cellspacing="1" cellpadding="5">
                <tr style="background-color: rgb(239, 243, 251);">
                    ...
                    <td>
                        <uc:DatePicker ID="dpNewsDate" runat="server" />
                    </td>
                    <td rowspan="2">
                        <table border="0" cellspacing="0">
                            <tr>
                                <td>
                                    <img height="55" alt='Image' src='<%=this.ResolveUrl("~/GetImage.ashx?type=2&id="+this.GroupID) %>' /></td>
                                <td>
                ...
                <tr style="background-color: rgb(239, 243, 251);">
                    ...
                    <td colspan="2">
                        <table border="0">
                            <tr>
                                <td>
                                    <asp:CheckBox ID="chbIsMain" runat="server" />
                                </td>
                            </tr>
                        </table>
                    </td>
