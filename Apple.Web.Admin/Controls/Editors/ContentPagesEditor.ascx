<%@ Control Language="C#" AutoEventWireup="true" Codebehind="ContentPagesEditor.ascx.cs"
    Inherits="Apple.Web.Admin.Controls.Editors.ContentPagesEditor" %>
<asp:MultiView ID="MvEditor" runat="server" ActiveViewIndex="0">
    <asp:View ID="ViewList" runat="server">
        ...
        <asp:ObjectDataSource ID="ObjectDataSourceItemsList" runat="server" DataObjectTypeName="Erc.Apple.Data.ContentPage"
            DeleteMethod="Delete" SelectMethod="GetAll" TypeName="Erc.Apple.Data.ContentPages">
    ...
    <asp:View ID="ViewEdit" runat="server">
        ...
        <asp:ObjectDataSource ID="ObjectDataSourceEditItem" runat="server" DataObjectTypeName="Erc.Apple.Data.ContentPage"
            InsertMethod="Add" SelectMethod="GetByID" TypeName="Erc.Apple.Data.ContentPages"
