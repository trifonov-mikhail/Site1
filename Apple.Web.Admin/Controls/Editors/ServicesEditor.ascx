<%@ Control Language="C#" AutoEventWireup="true" Codebehind="ServicesEditor.ascx.cs"
    Inherits="Apple.Web.Admin.Controls.Editors.ServicesEditor" %>
<%@ Register TagPrefix="uc" TagName="editor" Src="~/Controls/Editors/ServiceEditor.ascx" %>
<asp:MultiView ID="MvEditor" runat="server" ActiveViewIndex="0">
    ...
    <div style="text-align:left;">
        ...
        SelectMethod="Services_GetAllByLanguageRegionCitySpecializationAdmin"
            TypeName="Erc.Apple.Data.Services" DataObjectTypeName="Erc.Apple.Data.Service"
    ...
    <asp:View ID="ViewEdit" runat="server">
		...
		<table width="200" cellpadding="5">
			...
			<tr style="background-color: rgb(239, 243, 251);">
				...
				<td>
				<asp:DropDownList ID="ddlStatus" runat="server" DataSourceID="ODSServiceStatus" DataTextField="Name" DataValueField="ID"></asp:DropDownList>
				</td>
			</tr>
			<tr style="background-color: rgb(239, 243, 251);">
        ...
        <asp:ObjectDataSource ID="ODSServiceStatus" runat="server" SelectMethod="GetAll"
            TypeName="Erc.Apple.Data.ServiceStatuses" DataObjectTypeName="Erc.Apple.Data.ServiceStatus">            
        </asp:ObjectDataSource>
