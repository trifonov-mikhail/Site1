<%@ Control Language="C#" AutoEventWireup="true" Codebehind="CaseStudiesEditor.ascx.cs"
    Inherits="Apple.Web.Admin.Controls.Editors.CaseStudiesEditor" %>
<%@ Register TagPrefix="uc" TagName="DatePicker" Src="~/Controls/DatePicker.ascx" %>
<%@ Register TagPrefix="uc" TagName="editor" Src="~/Controls/Editors/CaseStudyEditor.ascx" %>
...
<asp:MultiView ID="MvEditor" runat="server" ActiveViewIndex="0">
    <asp:View ID="ViewList" runat="server">
        ...
        <asp:ObjectDataSource ID="ObjectDataSourceItemsList" runat="server" SelectMethod="GetAll"
            TypeName="Erc.Apple.Data.CaseStudies" DataObjectTypeName="Erc.Apple.Data.CaseStudy" DeleteMethod="DeleteGroup">
            <SelectParameters>
        ...
        <div style="width: 100%; text-align: left;">
            <table width="550" border="0" cellspacing="1" cellpadding="5">
                <tr style="background-color: rgb(239, 243, 251);">
                    ...
                    <td>
                        <uc:DatePicker ID="dpCaseStudyDate" runat="server" />
                    </td>--%>
                </tr>
                <tr>
                    ...
                    <td style="background-color: rgb(239, 243, 251);">
                        <table border="0" cellspacing="0">
                            <tr>
                                <td>
                                    <img height="55" alt='Image' src='<%=this.ResolveUrl("~/GetImage.ashx?type=3&id="+this.GroupID) %>' /></td>
                                <td>
