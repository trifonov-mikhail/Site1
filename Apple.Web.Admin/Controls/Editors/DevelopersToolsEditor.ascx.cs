...
{
    public partial class DevelopersToolsEditor : UserControlBase, Apple.Web.Admin.Interfaces.IAddControl
    {
        ...
        {
            DevelopersTools dao = new DevelopersTools();
            DevelopersTool item = dao.GetByLangGroup("ru", GroupID);

            if (item != null)
            {
                //dpDevelopersToolDate.SelectedDate = item.Date;
        ...
        {
            DevelopersToolEditor editor = (DevelopersToolEditor)sender;
        ...
        private void Save()
        {
            foreach (RepeaterItem item in RepeaterLang.Items)
            {
                ...
                {
                    DevelopersToolEditor editor = (DevelopersToolEditor)item.FindControl("editor");
                    //editor.DevelopersToolDate = dpDevelopersToolDate.SelectedDate;
        ...
        public void AddButton_Click(object sender, EventArgs e)
        {
            ...
            GroupID = DevelopersTools.GetNextGroupID();
            RepeaterLang.DataBind();
            MvEditor.ActiveViewIndex = 1;
