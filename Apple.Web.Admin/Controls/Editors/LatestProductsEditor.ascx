<%@ Control Language="C#" AutoEventWireup="true" Codebehind="LatestProductsEditor.ascx.cs"
    Inherits="Apple.Web.Admin.Controls.Editors.LatestProductsEditor" %>
<%@ Register TagPrefix="uc" TagName="DatePicker" Src="~/Controls/DatePicker.ascx" %>
<%@ Register TagPrefix="uc" TagName="editor" Src="~/Controls/Editors/LatestProductEditor.ascx" %>
