...
{
    public partial class ServiceEditor : UserControlBase
    {
        public int GroupID
        {
            get
		...
		public int ServiceStatus
		{
			get
			{
				return Convert.ToInt32(ViewState["ServiceStatus"]);
			}
			set
			{
				ViewState["ServiceStatus"] = value;
			}
		}
		...
		protected void DetailsViewEditItem_ItemUpdating(object sender, DetailsViewUpdateEventArgs e)
		{
			...
			e.NewValues["ServiceStatusID"] = this.ServiceStatus;
		}
        ...
        protected void DetailsViewEditItem_ItemInserting(object sender, DetailsViewInsertEventArgs e)
        {
			...
			e.Values["ServiceStatusID"] = this.ServiceStatus;
        }
