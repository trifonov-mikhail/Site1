<%@ Control Language="C#" AutoEventWireup="true" Codebehind="DevelopersToolsEditor.ascx.cs"
    Inherits="Apple.Web.Admin.Controls.Editors.DevelopersToolsEditor" %>
<%@ Register TagPrefix="uc" TagName="DatePicker" Src="~/Controls/DatePicker.ascx" %>
<%@ Register TagPrefix="uc" TagName="editor" Src="~/Controls/Editors/DevelopersToolEditor.ascx" %>
...
<asp:MultiView ID="MvEditor" runat="server" ActiveViewIndex="0">
    <asp:View ID="ViewList" runat="server">
        ...
        <asp:ObjectDataSource ID="ObjectDataSourceItemsList" runat="server" SelectMethod="GetAll"
            TypeName="Erc.Apple.Data.DevelopersTools" DataObjectTypeName="Erc.Apple.Data.DevelopersTool" DeleteMethod="DeleteGroup">
            <SelectParameters>
        ...
        <div style="width: 100%; text-align: left;">
            <table width="550" border="0" cellspacing="1" cellpadding="5">
                <tr style="background-color: rgb(239, 243, 251);">
                    ...
                    <td>
                        <uc:DatePicker ID="dpDevelopersToolDate" runat="server" />
                    </td>--%>
                </tr>
                <tr>
                    ...
                    <td style="background-color: rgb(239, 243, 251);">
                        <table border="0" cellspacing="0">
                            <tr>
                                <td>
                                    <img height="55" alt='Image' src='<%=this.ResolveUrl("~/GetImage.ashx?type=5&id="+this.GroupID) %>' /></td>
                                <td>
