...
<asp:MultiView ID="MvEditor" runat="server" ActiveViewIndex="0">
	...
	<asp:ObjectDataSource runat="server" ID="dsSerials" TypeName="Erc.Apple.Data.iPadActionSerials" SelectMethod="GetSerialNumbers">
	</asp:ObjectDataSource>
	<asp:ObjectDataSource runat="server" ID="dsSellers" TypeName="Erc.Apple.Data.iPadActionSerials" SelectMethod="GetSellers">
	</asp:ObjectDataSource>
	<asp:ObjectDataSource runat="server" ID="dsEmails" TypeName="Erc.Apple.Data.iPadActionSerials" SelectMethod="GetEmails">
	</asp:ObjectDataSource>
	<%--
