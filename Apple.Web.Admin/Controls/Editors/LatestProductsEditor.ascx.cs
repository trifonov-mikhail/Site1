...
{
    public partial class LatestProductsEditor : UserControlBase, Apple.Web.Admin.Interfaces.IAddControl
    {
        ...
        {
            LatestProductEditor editor = (LatestProductEditor)sender;
        ...
        private void Save()
        {
            foreach (RepeaterItem item in RepeaterLang.Items)
            {
                ...
                {
                    LatestProductEditor editor = (LatestProductEditor)item.FindControl("editor");
