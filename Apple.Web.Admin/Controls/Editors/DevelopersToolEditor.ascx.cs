...
{
    public partial class DevelopersToolEditor : UserControlBase
    {
        public int GroupID
        {
            get
        ...
        private DateTime? developersToolDate;

        public DateTime? DevelopersToolDate
        {
            get { return developersToolDate; }
            set { developersToolDate = value; }
        }
		...
		protected void DetailsViewEditItem_ItemUpdating(object sender, DetailsViewUpdateEventArgs e)
		{
            ...
            e.NewValues["Date"] = DevelopersToolDate;
        ...
        protected void DetailsViewEditItem_ItemInserting(object sender, DetailsViewInsertEventArgs e)
        {
            ...
            e.Values["Date"] = DevelopersToolDate;
        }
