...
{
    public partial class LatestProductEditor2 : UserControlBase
    {
        public int GroupID
        {
            get
        ...
        private DateTime? latestProductDate;

        public DateTime? LatestProductDate
        {
            get { return latestProductDate; }
            set { latestProductDate = value; }
        }
		...
		protected void DetailsViewEditItem_ItemUpdating(object sender, DetailsViewUpdateEventArgs e)
		{
            ...
            e.NewValues["Date"] = LatestProductDate;
        ...
        protected void DetailsViewEditItem_ItemInserting(object sender, DetailsViewInsertEventArgs e)
        {
            ...
            e.Values["Date"] = LatestProductDate;
        }
